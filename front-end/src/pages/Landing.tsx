  ...
  return (
    <main className="flex flex-col items-center overflow-x-hidden">
      ...
      <section className="relative w-full min-h-[calc(100vh-4rem)] flex items-center justify-center">
        ...
        {/* Ambient glow blobs */}
        <div className="absolute top-1/4 left-1/3 w-[28rem] h-[28rem] bg-indigo-600/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute bottom-1/4 right-1/4 w-[24rem] h-[24rem] bg-violet-600/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          <motion.div {...fadeUp(0)} className="mb-7">
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-medium bg-indigo-500/10 text-indigo-400 border border-indigo-500/25 shadow-lg shadow-indigo-500/10">
          ...
          >
            ...
            <br />
            <span className="text-slate-100">Stock Trend Predictions</span>
          </motion.h1>
          ...
          >
            <Button
              ...
              size="lg"
              className="bg-indigo-600 hover:bg-indigo-500 text-white px-8 shadow-xl shadow-indigo-500/30 hover:shadow-indigo-500/50 transition-all duration-200 rounded-xl text-base"
            >
              Start Predicting
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-slate-700 text-slate-300 hover:bg-slate-800 hover:text-slate-100 rounded-xl text-base"
              onClick={() => navigate('/dashboard')}
            >
      ...
      <section className="w-full max-w-6xl mx-auto px-6 py-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {features.map(({ Icon, title, description, color, bg, border }, i) => (
            ...
            >
              <Card
                className={`h-full bg-slate-900/60 border-slate-800 hover:border-slate-700 hover:bg-slate-900/80 transition-all duration-300 hover:shadow-xl hover:shadow-black/20 hover:-translate-y-1`}
              >
      ...
      <section className="w-full max-w-5xl mx-auto px-6 pb-24">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="relative overflow-hidden rounded-2xl border border-indigo-800/30 bg-gradient-to-br from-indigo-950/80 via-slate-900/90 to-violet-950/60 p-12 text-center"
        >
          {/* Ambient glow */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-32 bg-indigo-600/20 rounded-full blur-3xl pointer-events-none" />
          ...
          <Button
            onClick={() => navigate('/dashboard')}
            size="lg"
            className="relative bg-indigo-600 hover:bg-indigo-500 text-white px-10 shadow-xl shadow-indigo-500/30 hover:shadow-indigo-500/50 transition-all duration-200 rounded-xl text-base"
          >
            Start Predicting
            <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
